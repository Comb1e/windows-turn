...
3. Start recording. Cover 10°, 20°, …, 120° in opening and closing directions. At measured positions, choose **Capture 2-second hold**. Low-angle keyboard labels are attached to the matching frames automatically and override checkpoint labels for training; independent checkpoint values remain preserved for evaluation.
